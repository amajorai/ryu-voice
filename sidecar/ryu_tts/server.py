...
# (`RYU_EXT_TOKEN`). FAIL-CLOSED for every route except /health: no token
# configured => reject all. Closes unauthenticated loopback/CSRF access to the
# synthesis + model-install endpoints.
